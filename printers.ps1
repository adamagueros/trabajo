...
Write-Host ""
$failed -split " "
Clear-Variable -name final -scope global -ErrorAction Ignore
Clear-Variable -name failed -scope global -ErrorAction Ignore
Clear-Variable -name netfail -scope global -ErrorAction Ignore
